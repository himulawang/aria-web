...
import { TaskPieceMap } from "./TaskPieceMap";
...
export const TaskOverview: Component<TaskOverviewProps> = (props) => {
  return (
    <div class="space-y-4">
      ...
      {/* BitTorrent Piece Matrix Visualization */}
      <TaskPieceMap
        bitfield={props.task?.bitfield}
        numPieces={props.task?.numPieces}
        pieceLength={props.task?.pieceLength}
      />
    </div>
  );
};
