...
const Layout: Component<LayoutProps> = (props) => {
    ...
    const navItems = [
        { label: "Downloads", view: "downloads", position: "sidebar" },
        { label: "Settings", view: "settings", position: "sidebar" },
        { label: "Status", view: "status", position: "sidebar" },
    ];
            ...
            <div class="layout-main-wrapper">
                <aside class="layout-sidebar">
                    <nav class="layout-nav">
                        <For
                            each={navItems.filter(
                                (i) => i.position === "sidebar",
                            )}
                        >
                            {(item) =>
                                item.view === "settings" ? (
